...
public final class Ex4 {
	...
	//OPTION1_1:
	public static final String OPTION1_CLASS = "org.apache.uima.tutorial.ex3.RoomNumberAnnotator";
	public static final String[] LOCATIONS = new String[]{"Watson - Yorktown", "Watson - Hawthrone I", "Watson - Hawthorne II"};
	public static final String[] PATTERNS = new String[]{"\\b[0-4]\\d[0-2]\\d\\d\\b","\\b[G1-4][NS]-[A-Z]\\d\\d\\b","\\bJ[12]-[A-Z]\\d\\d\\b"};
	public static final Parameter<List<String>> OPTION1_PARAM1 = createParam("Locations",Arrays.asList(LOCATIONS));
	public static final Parameter<List<String>> OPTION1_PARAM2 = createParam("Patterns",Arrays.asList(PATTERNS));
	...
	public static final Parameter<String> OPTION3_PARAM1 = createParam("test",
			"param1");
