...
public class YAMLParser extends Parser {
  ...
  /**
   * Takes a resource file defined by a yaml and turns it to Map<String,Object> corresponding to its
   * parameters.
   */
  @Override
  public Map<String, Object> getResourceMap(String resource) throws FileNotFoundException {
  ...
  public CollectionReaderDescriptor buildCollectionReaderDescriptor() {
    Map<String, Object> resMap = (Map<String, Object>) confMap.get("collection-reader");
  ...
  public PipelineDescriptor buildPipelineDescriptor() {
    List<Map<String, Object>> phaseResMaps = (List<Map<String, Object>>) confMap.get("pipeline");
  ...
  public List<OptionDescriptor> buildOptionDescriptors(Map<String, Object> phaseResMap) {
   ...
   * @return
   */
  public OptionDescriptor buildOptionDescriptor(Map<String, Object> optionResMap) {
  ...
  /**
   * Takes the specified yaml component and flattens the "inherits" therein so that it only contains
   * the "class" and associated parameters.
   * 
   * @param resMap
  ...
  /**
   * Combines map1 and map2 into a single a map by taking the union of their keys.
   * 
   * @param map1
   * @param map2
   * @return the union of map1 and map2.
   */
  private static <K, V> Map<K, V> combineMaps(Map<K, V> map1, Map<? extends K, ? extends V> map2) {
    map1.putAll(map2);
    return map1;
  }
  ...
  private ConsumerDescriptor buildConsumerDescriptor(Map<String, Object> resMap) {
    String className = buildClass(resMap);
  ...
  protected Map<String, ScoreDescriptor> buildScores() {
    List<Map<String, Object>> metrics = (List<Map<String, Object>>) confMap.get("metrics");
    List<Map<String, Object>> scores = null;
    try {
      String path = (String) metrics.get(0).get("inherit");
      Map<String, Object> scoreComponents = (Map<String, Object>) getResourceMap(path + ".yaml");
    ...
    for (Map<String, Object> score : scores) {
      ...
      ScoreDescriptor sd = new ScoreDescriptor((Double) score.get("cost"),
              (Double) score.get("benefit"));
  ...
  public PersistenceProviderDescriptor buildPersistenceProviderDescriptor() {
    List<Map<String, Object>> resMapList = (List<Map<String, Object>>) confMap
    ...
    Map<String, Object> resMap = resMapList.get(0);
    String className = buildClass(resMap);
    return new PersistenceProviderDescriptor(className,resMap);
  }
