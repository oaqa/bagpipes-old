...
public class SingleTraceRandomExplorationStrategy<T, E extends ExecutableComponent<T>>
		extends ExplorationStrategy<T, E> {

	public SingleTraceRandomExplorationStrategy(ExplorerDescriptor explorerDesc) {
		super(explorerDesc);
	}
