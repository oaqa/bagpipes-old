package edu.cmu.lti.oaqa.cse.configuration.parameter;
...
public  class Parameter<T> {
	...
	public static BooleanParameter newParameter(String name, Boolean val){
		return new BooleanParameter(name,val);
	}
